= Tc2006.2 Programming Languages

_Tecnológico de Monterrey, Estado de México._

This project contains all the source files that the course instructor will be writing in class during the 2018 August-December semester.
...
2. Clone this repository. Type at the terminal:
    ...
    git clone https://github.com/ariel-ortiz/201813-tc2006.2.git tc2006
